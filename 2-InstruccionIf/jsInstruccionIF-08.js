...
/*Se pide ingresar una edad y un estado civil
	...
	a todos los menores de edad, mostrar el mensaje "respeta a tus mayores" corregir que esta mal
	a los adultos mayores( mas de 60 años) tambien informar "sos persona de riesgo"
	a los niños tambien informar "hagan la tarea" corregir que esta mal
...
function mostrar()
{
	...
	/*if(edadIngresada<18 && edadIngresada>12 && estadoCivil=="Casado" || estadoCivil=="Divorciado")
	{
		alert("sos muy joven para no ser soltero");
	}*/
}//FIN DE LA FUNCIÓN